...
import { askMoby } from '../utils/ask_moby';
...
export function ConsolePage() {
  ...
  useEffect(() => {
    ...
    client.addTool(
      {
        name: 'ask_triple_whale',
        description:
          'Retrieves any store information, ecommerce related question, or any information at all pertaining to triple whale or its suite of products.',
        parameters: {
          type: 'object',
          properties: {
            shopId: {
              type: 'string',
              description:
                'the shopId of the store (eg: madisonbraids.myshopify.com)',
            },
            question: {
              type: 'string',
              description: 'a concise version of the question asked',
            },
          },
          required: ['lat', 'lng', 'location'],
        },
    ...
    <div data-component="ConsolePage">
      <div className="content-top">
        ...
        <Toggle
          ...
          labels={['Chat', 'Debug']}
          values={['chat', 'debug']}
          onChange={(isEnabled) => setDebug(isEnabled ? true : false)}
        />
      </div>
